...
def validate_args(args, defaults={}):
    ...
    if args.hetero_mode:
        ...
        args.hetero_device_types = args.hetero_device_types.split()
    ...
    if args.hetero_mode == "pp":
        ...
        counter = 0
        num_layers = 0
        args.hetero_pipeline_stages = [int(item) for item in args.hetero_pipeline_stages.split() ]
...
def _add_hetero_args(parser):
    ...
    group.add_argument('--hetero-pipeline-stages', nargs='*', type=str, default=None,
